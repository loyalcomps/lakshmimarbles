...
class AccountInvoiceLine(models.Model):
    ...
    #                 'category_id':pdct.categ_id,
    #                 'hsn':pdct.hsn,
    #                 'customer_tax_id': pdct.taxes_id,
...
class PurchaseOrderline(models.Model):
    ...
    price_taxvalue = fields.Float(compute='_compute_price_tax', string='Tax Amount',
                                          digits=dp.get_precision('Product Price'), store=True)
    ...
    def _compute_price_tax(self):
        ...
        self.price_taxvalue = taxes['total_included'] - taxes['total_excluded']
        if self.order_id:
            self.price_subtotal_tax = self.price_subtotal_tax
