...
class ProductTemplate(models.Model):
    ...
    # @api.multi
    # def get_pos_pricelists(self):
    #     for rec in self:
    #         rec._get_pos_pricelists()
    #
    # @api.multi
    # def _get_pos_pricelists(self):
    #     self.pos_pricelists = self.env['pos.pricelist'].search(
    #         [
    #             ('show_on_products', '=', True)
    #         ]
    #     )
    # def _set_pos_pricelists(self):
    #     for pricelist in self.pos_pricelists:
    #         if pricelist.product_price:
    #             _logger.debug("Updating Price: %s", pricelist.product_price)
    #             pricelist.price_set(self, pricelist.product_price)
    #
    # pos_pricelists = fields.One2many(
    #     comodel_name="pos.pricelist",
    #     string="POS Pricelists",
    #     compute="get_pos_pricelists",
    #     inverse="_set_pos_pricelists"
    # )
    # pos pricelist
