...
class Qltyvendorwise(ReportXlsx):
 ...
 (
  select pt.id as product_id ,sum (sh.quantity) as onhands,
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        sheet.merge_range('A3:G3', "Vendor Wise Profit and Loss Report ", blue_mark2)
        sheet.merge_range('A4:G4','From ' + date_object_date_start.strftime('%d-%m-%Y') + ' - To ' + date_object_date_end.strftime('%d-%m-%Y'),blue_mark2)
        sheet.merge_range('A5:G5', "VENDOR NAME :- "+  vendor_name, blue_mark2)


        sheet.write('A7', "Sl No", blue_mark)
        sheet.write('B7', "Product", blue_mark)
        sheet.write('C7', "Purchase Amount", blue_mark)
        sheet.write('D7', "Sale Amount", blue_mark)
        sheet.write('E7', "Current Inventory Value", blue_mark)
        sheet.write('F7', "Cost Of Sale", blue_mark)
...
Qltyvendorwise('report.qlty_vendorwise_xls.qlty_vendorwise_xls.xlsx', 'sale.order')
