    ...
    def get_attendances(self):
        for att_sheet in self:
            ...
            if emp.contract_id.working_hours:
                calender_id = emp.contract_id.working_hours
            else:
            ...
            def get_work_intervals(calender, day_start, day_end):
                ...
                working_intervals = []
                for att in calender.get_attendances_for_weekday(day_start):
                ...
                clean_work_intervals = calender.interval_clean(working_intervals)
            ...
            def interval_without_leaves(interval, leave_intervals):
                intervals = emp.contract_id.working_hours.interval_remove_leaves(interval, leave_intervals)
                return intervals
