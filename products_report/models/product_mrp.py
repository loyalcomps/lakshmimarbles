...
class product_mrp_compare(models.Model):
    _name = 'report.product.mrp.compare'
    ...
    def init(self):
        ...
        tools.drop_view_if_exists(self._cr, 'report_product_mrp_compare')
        self._cr.execute("CREATE OR REPLACE VIEW report_product_mrp_compare AS (%s)" % (self._product_mrp_select()))
