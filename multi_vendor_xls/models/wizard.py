...
class QltyCat(models.TransientModel):
    _name = "multi.vendor.xls"
    _description = "vendor wise report"
    ...
    def export_xls(self):
        ...
        if context.get('xls_export'):
            return {'type': 'ir.actions.report.xml',
                    'report_name': 'multi_vendor_xls.qlty_productsale_xls.xlsx',
                    'datas': datas,
    ...
    def export_pdf(self):
        ...
        datas['model'] = 'account.invoice'
        datas['form'] = self.read()[0]
        report_name = 'multi_vendor_xls.productsale_report_pdf'
        for field in datas['form'].keys():
            if isinstance(datas['form'][field], tuple):
                datas['form'][field] = datas['form'][field][0]
