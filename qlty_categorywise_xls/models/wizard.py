...
class QltyCategory(models.TransientModel):
    _name = "qlty.category.xls"
    ...
    def export_xls(self):
        ...
        if context.get('xls_export'):
            return {'type': 'ir.actions.report.xml',
                    'report_name': 'qlty_categorywise_xls.qlty_category_xls.xlsx',
                    'datas': datas,
                    'name': 'Product Category Wise Report'
                    }
