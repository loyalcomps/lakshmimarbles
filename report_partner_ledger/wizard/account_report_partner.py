...
class AccountPartnerReport123(models.TransientModel):
    _name = "account.partner.report123"
    ...
    def check_report(self):
        ...
        return self.env['report'].get_action(self, 'report_partner_ledger.report_partnerledger1', data=datas)
