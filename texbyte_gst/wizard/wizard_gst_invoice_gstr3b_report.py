...
class GSTInvoice3BWizard(models.TransientModel):
    ...
    _name = 'texbyte_gst.invoice.report.gstr3b.wizard'
    ...
    def get_valid_invoices(self):
        ...
        self.all_invoices = self.env['account.invoice'].search([('date_invoice','>=', from_date),('date_invoice','<=', to_date)])   #Customer Invoice & Vendor Bills
    ...
    def generate_gstr3b_report(self):
        ...
        return {
            ...
            'res_model': 'texbyte_gst.invoice.report.gstr3b.wizard',
            'view_mode': 'form',
            'view_type': 'form',
            'res_id': self.id,
            'views': [(False, 'form')],
    ...
    def generate_3b_report(self, wb1):
        ...
        for invoice in self.sorted_invoices:
            for invoice_line in invoice.invoice_line_ids:
                ...
                elif invoice.type in ('in_invoice', 'in_refund'): #and invoice.reverse_charge: #Vendor Bills with Reverse Charge applicablle
